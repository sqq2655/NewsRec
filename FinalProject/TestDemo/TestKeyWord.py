...
# 2. 初始化handler,并配置formater 每五秒切分日志
log_file_handler = TimedRotatingFileHandler(filename="analysis/kwg.log",
                                            when="S", interval=5,
                                            backupCount=20)
...
class SelectKeyWord:
    ...
    def getKeyWords(self):
        ...
        # "1800": {
        #     "tag": 1800,
        #     "title": "男子10元机选中大乐透1000万 携妻女现身兑奖-票",
        #     "content": "1月15日体彩大笑着表示幸福来得太突然了，还没未来益......"
        # }
        stop_words_list = [line.strip() for line in open("stopwords/stop_words.txt", 'r').readlines()]
