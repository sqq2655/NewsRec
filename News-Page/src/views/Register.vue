  ...
  methods: {
    ok() {
      if (this.account !== '' && this.pwd !== '' && this.gender !== '' && this.username !== ''){
        ...
        if('' === this.username) this.unameError = '用户名不能为空'
        if('' === this.gender) this.sexError = '性别不能为空'
      }
    },
    cancel() {
      if (this.account !== '' && this.pwd !== ''){
        ...
        this.unameError = '用户名不能为空'
        this.sexError = '性别不能为空'
      }
    },
    deleteTags(item){
